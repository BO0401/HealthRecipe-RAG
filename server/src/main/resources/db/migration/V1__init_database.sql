/*
 ...
 Source Schema         : health_recipe_rag

 Target Server Type    : MySQL
 Target Server Version : 80045
 File Encoding         : 65001

 Date: 12/04/2026 15:23:54
*/
...
CREATE TABLE sys_recipe (
                            ...
                            steps         TEXT COMMENT '制作步骤(JSON或文本)',
...
-- 4. 食谱-食材关联表
-- ----------------------------
DROP TABLE IF EXISTS rel_recipe_ingredient;
...
-- 7. 知识库表 (RAG用)
-- ----------------------------
DROP TABLE IF EXISTS sys_vector_store;
